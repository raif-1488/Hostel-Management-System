<?php
    ...
    if (isset($_GET['deleted']) && $_GET['deleted'] == 1) {
        echo "<script>
                ...
                window.location.href = 'manage-students.php'; // Redirect to remove ?deleted=1
              </script>";
        exit();
    }
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    ...
                    <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Vinodini Hostel Student Management</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                            <a href="bookings.php"><button type="button" class="btn btn-block btn-md btn-success">Add New Student </button></a>
                                ...
                                <div class="table-responsive">
                                    ...
                                    <thead class="thead-dark">
                                        ...
                                        <td><a href="edit-students.php?regno=<?php echo $row->regno;?>" title="Edit"><i class="icon-note"></i></a></td>&nbsp;&nbsp;
                                        </tr>
                                            <?php
                                        $cnt=$cnt+1;
                                            } ?>
