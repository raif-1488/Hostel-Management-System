<?php
  ...
  //  $imagePath = "../assets/girls_images/{$regno}.png";

    // Use default if not found
  //  if (!file_exists($imagePath)) {
  //    $imagePath = "../assets/images/default-profile.png";
   // }
?>
        ...
        <div class="page-wrapper">
		    ...
		    <!-- Right Side: Profile Picture -->    
	            <div class="col-5 text-right align-self-center">
	                 <div style="width: 80px; height: 80px; border: 2px solid #ccc; border-radius: 10px; overflow: hidden; display: inline-block;">
	                    <img src="<?php echo $imagePath; ?>"
				 alt="Profile Picture"
				 width="80" height="80"
				 style="object-fit: cover; border: 2px solid #ccc; border-radius: 10px;">
                    ...
                    <div class="table-responsive">
                                  <table id="zctb" class="table table-striped table-bordered no-wrap">
                                    ...
                                    while($row=$res->fetch_object())
                                    {
                                          ...
                                          <td colspan="3"><?php echo $row->guardianContactno;?></td>   
                                          ...
                                          <?php echo $row->corresCIty;?>, <?php echo $row->corresPincode;?>
                                          ...
                                          <td colspan="6">
                                          <?php echo $row->pmntAddress;?>
                                          <?php echo $row->pmntCity;?>, <?php echo $row->pmntPincode;?>
                                          </td>
                                          </tr>
