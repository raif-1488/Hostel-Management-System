<?php
    ...
    $imagePath = "../assets/girls_images/{$regno}.jpg";
    
    // If image exists, use it; otherwise fallback
    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="page-wrapper">
		    ...
		    <!-- Profile picture aligned to right -->
		     <div class="profile-pic-box ml-3" style="width: 50px; height: 50px; border: 2px solid #ccc; border-radius: 10%; overflow: hidden;">
				<!--<?php
				    
				?> -->
				<img src="<?php echo $profilePicUrl; ?>" alt="Profile Picture"
				     class="rounded-circle ml-auto" width="60" height="60"
