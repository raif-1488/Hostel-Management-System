<?php
    ...
    $stmt=$mysqli->prepare("SELECT email,password,id FROM userregistration WHERE email=? and password=? ");
        ...
        $log="insert into userlog(userEmail,userIp,city,country) values('$uemail','$ip','$city','$country')";
        $mysqli->query($log);
        if($log){
    ...
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center position-relative"
            ...
            <div class="auth-box row">
                <div class="col-lg-7 col-md-5 modal-bg-img" style="background-image: url(assets/images/vinodini.png);">
                </div>
                <div class="col-lg-5 col-md-7 bg-white">
                    <div class="p-3">
                        ...
                        <h2 class="mt-3 text-center">Vinodini Student Login</h2>
