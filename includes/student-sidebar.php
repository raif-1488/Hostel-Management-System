...
<nav class="sidebar-nav">
    ...
    <ul id="sidebarnav">
       ...
       <!-- <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="book-hostel.php"
        ...
        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="MyDetails.php"
        aria-expanded="false"><i class="fas fa-bed"></i><span
        class="hide-menu">My Details</span></a></li>
        ...
        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="activity.php"
        aria-expanded="false"><i class="fas fa-cogs"></i><span
        class="hide-menu">My Activities</span></a></li>
